...
X_expected = torch.tensor([[ 3, 30],
        ...
        [ 3, 30],
        [ 3, 30]])
test_layer_output(X, mapping, output_shape, X_expected)
...
output_shape = (d, b, c)
test_layer_output(X, mapping, output_shape, X_expected)
#Todo: algorithm for finding all partitions of a set (in our specific case where it also needs to be divided by entities)