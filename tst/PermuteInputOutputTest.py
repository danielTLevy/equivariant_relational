...
if __name__ == '__main__': 
    ...
    assert test_block_with_permutation(X, entities, relation_i, relation_j, 1, 3)
    ...
    assert test_block_with_permutation(X, entities, relation_i, relation_j, 3, 2)
    ...
    assert test_block_with_permutation(X, entities, relation_i, relation_j, 1, 1)
